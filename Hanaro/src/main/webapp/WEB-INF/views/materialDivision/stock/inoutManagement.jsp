...
<html> 
<head>
	<title><fmt:message key="menu.materInoutMgmt"/></title>
	...
	function editCloseData(){
		...
		$("#closeAmount").numberspinner("setValue",record.DATA8);
		...
		if($("#formCloseEdit").form("validate")){
			...
			if($("#closeProdType").val()=="insert"){
				...
				if(sameRowIdx<0){					
					...
					for(var x=1;x<8;x++)
						newRow["DATA"+x] = "0";	
					newRow.DATA8 = $("#closeAmount").numberspinner("getValue");
	...
	function saveActualData(){
		...
		$.messager.confirm("<fmt:message key='info.confirm' />","<fmt:message key='ask.applyActualData' />",function(r){  
		    if (r){
				...
				for(var x=0;x<data.rows.length;x++){		
					data0.push(data.rows[x].DATA9);
					data1.push(data.rows[x].DATA0);
					data2.push(data.rows[x].DATA8);			
				}
		...
		$(document).ready(function(){			
		    ...
		    $('#inPartCode').combogrid({
		    	panelWidth:400,
		        url : 'getPartListCallBak?type=1002',
		        columns:[[  
...
<div region="center" style="padding:10px;">
    <div class="easyui-tabs" style="width:1180px;height:720px;" >
        <div title="<fmt:message key='menu.incomeMgmt' />" iconCls="icon-basket-add"  >
        <table>
        	<tr>
        		...
        		<td>
					<div iconCls="icon-basket-edit" class="easyui-panel"  title="<fmt:message key='menu.incomeMgmt' />" style="width:330px;height:660px;">  
        ...
        <div title="<fmt:message key='menu.outgoMgmt' />" iconCls="icon-basket-delete" >  
		<table>
        	<tr>
        		<td style="width:830px;height:660px;">
        		...
        		<td>
					<div iconCls="icon-basket-edit" class="easyui-panel"  title="<fmt:message key='menu.outgoMgmt' />" style="width:330px;height:660px;">  
					    <form:form action="inoutManagement" modelAttribute="outgoSheet"  id="outgoForm"   method="POST" name="outgoFormName" >
					    	<table style="margin:5px;">
					    		...
					    		<tr>
					    			<th><span  class="label-Leader-black"><fmt:message key="ui.label.outgoPlace"/></span></th>
					    			<td>
            ...
            <table class="easyui-datagrid" id="currentList" pagination="false"   border="false"
				...
				<thead>
					<tr>						
						...
						<th field="DATA7" width="100" sortable="true"  align="right"  formatter="numeric" styler="pointCell1"><fmt:message key="menu.currentStock"/></th>						
						<c:forEach begin="2" end="6" step="1" varStatus="item" >							
            ...
            <table class="easyui-datagrid" id="closeActualList" pagination="false"   border="false"
				...
				<thead>
					<tr>						
						...
						<th field="DATA7" width="100" sortable="true"  align="right"  formatter="numeric"  styler="pointCell1"><fmt:message key="ui.label.closeAmount"/></th>
						<th field="DATA8" width="100" sortable="true"  align="right"  formatter="numeric" styler="pointCell2"><fmt:message key="ui.label.actualStockAmount"/></th>
