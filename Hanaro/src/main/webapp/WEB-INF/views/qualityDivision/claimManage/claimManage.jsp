...
<head>
	...
	function agreeClick(rowIndex, rowData){
        ...
        var win = window.open("claimAgree?own=own&claimNo="+claimNo,"AgreeDetail","width=930,height=700,location=no,menubar=no,resizable=no,scrollbars=no,status=no,toolbar=no");
        win.focus();
	}
